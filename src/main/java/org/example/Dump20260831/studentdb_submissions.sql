...
CREATE TABLE `submissions` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKeiqoen8c565i0gq79ritryilw` (`assignment_id`,`student_id`),
...
INSERT INTO `submissions` VALUES (1,'testpdf.pdf','/uploads/submissions/de2aac55-1788-4a04-8a60-39bef38a2a24.pdf',3,'2026-08-30 09:10:06.213214',1);
...
-- Dump completed on 2026-08-31 10:27:16
